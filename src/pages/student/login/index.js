  ...
  const submit = async (e) => {
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_SITE_URL}/api/login/student`,
        {
          email,
          password,
        }
              ...
              <div className="card">
                <div className="card-body">
                  <p className="card-text ">
                    ...
                    recommendations, track your progress, and stay updated with
                    the latest developments in the educational landscape.
                  </p>
                  <Form>
