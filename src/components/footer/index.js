      ...
      <footer class='w-100 py-4 flex-shrink-0'>
        <div class='container py-4'>
          <div class='row gy-4 gx-5'>
            ...
            <div class='col-lg-2 col-md-6'>
              <h5 class='text-white mb-3'>Fundibot</h5>
              <ul class='list-unstyled text-light'>
                <li className='mb-2'>
                  <a href='https://fundi.net.za'>www.fundibot.net.za</a>
                </li>
                <li className='mb-2'>
                  <a href='mailto:aya@touch.net.za'>bqwabi@gmail.com</a>
                </li>
                <li className='mb-2'>
            ...
            <div class='col-lg-4 col-md-6'>
              ...
              <p class='small text-light'>
                Stay updated on the latest educational news, inspiring stories,
                and platform updates by following us on social media.
              </p>
